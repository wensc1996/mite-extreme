...
public abstract class EntityFishingHookTrans extends Entity {
   ...
   public Item getFishType() {
      ...
      if (Configs.wenscConfig.isOpenGAFish.ConfigValue) {
         ...
         Item[] fishTypeListStage0 = new Item[]{Item.appleRed, Item.potato, Item.banana, Item.bread, Item.carrot};

         Item[] fishTypeListStage1 = new Item[]{Item.ingotCopper, Item.ingotSilver, Item.ingotGold, Item.ironNugget};

         Item[] fishTypeListStage2 = new Item[]{Item.ingotMithril};
         ...
         if (this.worldObj.getBiomeGenForCoords(x, z) == BiomeBase.ocean && count == 0L) {
            ...
            if (this.rand.nextInt(3) == 0) {
               ...
               if(this.rand.nextInt(2) > 0) {
                  return fishTypeListStage0[this.rand.nextInt(4)];
               }
