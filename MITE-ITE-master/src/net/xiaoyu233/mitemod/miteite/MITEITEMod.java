...
//    jar -cvf mite-ga-p14-v0.1.9.jar .
    ...
    public InjectionConfig getInjectionConfig() {
        return InjectionConfig.Builder.of("MITE-GA-P14", MinecraftTrans.class.getPackage(), MixinEnvironment.Phase.INIT).setRequired().build();
    }
